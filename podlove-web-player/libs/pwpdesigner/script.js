function buildcss(color1,color2,color3) {
  ...
  if(color2 === undefined) {
    ...
    //color2hsl[1] = Math.max(Math.min(color1hsl[1]+20, 100), 0);
  ...
  if(color3 === undefined) {
    ...
    //color3hsl[1] = Math.max(Math.min(color1hsl[1]+30, 100), 0);
    color3hsl[2] = Math.max(Math.min(color1hsl[2]-30, 100), 0);
  } else {
    color3hsl = convHEXtoHSL(color3);
  }
  
  console.log([color1hsl,color2hsl,color3hsl,fontcolor,color1,color2,color3]);
