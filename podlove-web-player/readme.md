...
This is part of the “Podlove” initiative for a better podcasting experience. See [podlove.org](http://podlove.org) for more information.
...
This player is bundled with the [“PPP” project](http://podlove.org/podlove-podcast-publisher) and should be automatically rendered, so you don’t have to worry about anything.


## Credits

The Podlove Web Player is built by the [Podlove Team](http://podlove.org/).

It uses sources from [MediaElement.js](http://mediaelementjs.com/), [jQuery](http://jquery.com/) and [jQuery hashchange event](http://benalman.com/projects/jquery-hashchange-plugin/).

The used icons are built in as fonts and provided by [Font Awesome](http://fortawesome.github.com/Font-Awesome/), [Zocial](http://zocial.smcllns.com/), [Iconic](http://somerandomdude.com/work/iconic/), [Elusive](http://aristeides.com/), [Linecons](http://designmodo.com/linecons-free/), [Entypo](http://www.entypo.com), [Web Symbols](http://www.justbenicestudio.com/studio/websymbols/), [Modern Pictograms](http://thedesignoffice.org/project/modern-pictograms/).
...
Takes chapter string from the defined custom field (the standard WordPress ones) and builds an interactive chapter table. Can be referenced to an external text file, too.
...
* fresh versions of mediaelement.js and jQuery
