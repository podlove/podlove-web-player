...
//            setNewHeight(summary);
      ...
      function setNewHeight(element) {
        var height = element.hasClass('active') ? element.data('height') : '0';
        console.log('summary data-height', height);
        element.height(height + 'px');
        setTimeout(function () {
          console.log('summary height', element.height() + 'px');
        }, 1000);
      }
