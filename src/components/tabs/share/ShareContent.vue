<template>
  <div class="content" id="tab-share--content">
    <div class="content-option" id="tab-share--content--show" v-if="show.link" :class="{active: isActive('show')}" :style="isActive('show') ? activeContentStyle : {}" @click="setContent('show')">
    ...
    <div class="content-option" id="tab-share--content--episode" :class="{active: isActive('episode')}" :style="isActive('episode') ? activeContentStyle : {}" @click="setContent('episode')">
    ...
    <div class="content-option"  id="tab-share--content--chapter" v-if="currentChapter" :class="{active: isActive('chapter')}" :style="isActive('chapter') ? activeContentStyle : {}" @click="setContent('chapter')">
    ...
    <div class="content-option" id="tab-share--content--time" :class="{active: isActive('time')}" :style="isActive('time') ? activeContentStyle : {}" @click="setContent('time')">
